...
const products = [
    ...
    { id: 5, name: "Lenovo IdeaPad 3", category: "Laptops", price: "$7,000.00 MXN", img: "./src/img/productos/img_Andy/LENOVO2.jpg" },
   ...
   // { id: 33, name: "HP i5 G420, hasta 32 GB de RAM, SSD 3 TB, Windows 11", category: "Computadoras", price: "$6,799 MXN", img:"./src/img/productos/img_Jluis/HP3_Desktop_1.png" },
    ...
    { id: 40, name: "Lenovo IdeaPad 3", category: "Laptops", price: "$9,990.00 MXN", img: "./src/img/productos/img_Mariana/LenovoIdeaPad1.webp" },
    ...
    { id: 47, name: "Google Pixel 8", category: "Celulares", price: "$19,000.00 MXN", img: "./src/img/productos/img_Mariana/GooglePixel1.jpg" },
...
function redirectToCart() {
  ...
  localStorage.setItem('isAdmin', true); // true para administrador, false para usuario regular
